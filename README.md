# RateYourProfessor Application

This repository contains the frontend and backend for the RateYourProfessor application.
...
The backend is an Express.js server with a SQLite database for storing professor ratings.
