...
app.use(cors({ origin: ['https://enchanting-fudge-700e94.netlify.app', 'http://localhost:3000'], credentials: true, methods: "GET,HEAD,PUT,PATCH,POST,DELETE", allowedHeaders: "Content-Type,Authorization" }));
app.use(helmet());
app.use(rateLimit({
