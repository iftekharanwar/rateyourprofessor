...
app.use(cors({ origin: ['http://euphonious-cucurucho-774f46.netlify.app', 'http://localhost:3000'], credentials: true, methods: "GET,HEAD,PUT,PATCH,POST,DELETE", allowedHeaders: "Content-Type,Authorization" }));
app.use(helmet());
app.use(rateLimit({
